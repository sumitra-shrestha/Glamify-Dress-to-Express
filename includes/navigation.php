        ...
        <div class="mt-1 text-center">
            <div class="socialBar d-flex ">
                ...
                <div class="col-md-3 text-right">
                    <a href="login.php" class="">Log In/Sign Up</i></a>
                </div>
            </div>
            <hr />
                    ...
                    <div class="input-group input-group-md">
                        <form class="form-control border-0" action="index.php" method="POST">
                            <input type="text" name="searchQuery" placeholder="Enter the product name to search..."
                                class=" form-control" />
                            <button class="search-btn" name="searchBtn" type="submit"><i class="fa-solid fa-magnifying-glass input-group-text"></i></button>
                        </form>
                    </div>
